...
/*typedef int8 model_t;
typedef int8 activation_t;
typedef int16 mult_t;
typedef int32 accum_t;
typedef uint8 img_t;
typedef int8 bits_t;*/
...
typedef struct fire_model_2 FIRE(64,16,64) fire_model_2;
typedef struct fire_model_3 FIRE(128,16,64) fire_model_3;
typedef struct fire_model_4 FIRE(128,32,128) fire_model_4;
typedef struct fire_model_5 FIRE(256,32,128) fire_model_5;
typedef struct fire_model_6 FIRE(256,48,192) fire_model_6;
typedef struct fire_model_7 FIRE(384,48,192) fire_model_7;
...
typedef struct net_model {
	...
	model_t convDet[CONVDET_CHANNELS][3][3][768];
